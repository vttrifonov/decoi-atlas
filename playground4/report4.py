...
x2 = analysis.feature_data1('FCGR1A')
...
x3 = x3.sel(feature_id=['FCGR1A']).todense()
x3 = x3.sel(coef='rpk')
x3 = x3.to_dataframe().reset_index()
x3['c5ar1_q3'] = quantile(np.expm1(x3.c5ar1), q=3)
x3['fcgr1a_q3'] = quantile(np.expm1(x3.rpk), q=3)
x3 = x3[x3['cell_integrated_snn_res.0.3']==2]

x4 = sm.stats.Table.from_data(x3[['c5ar1_q3', 'fcgr1a_q3']])
print(
    plot_table(x4)
)
